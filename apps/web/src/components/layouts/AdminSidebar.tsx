...
import { LayoutDashboard, ShieldCheck, Users, Menu, X, Tags, HeartPlus } from 'lucide-react';
...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed md:static top-0 left-0 z-40 w-64 border-r border-brand-line bg-white min-h-screen flex flex-col transition-transform md:transition-none ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
        }`}>
