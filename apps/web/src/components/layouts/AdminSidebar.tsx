...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 z-40 h-screen w-64 border-r border-brand-line bg-white flex flex-col overflow-hidden transition-transform md:sticky md:top-0 md:h-screen md:transition-none ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
        }`}>
