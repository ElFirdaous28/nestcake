          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-brand-line">
              {users.map((user) => {
                ...
                const professional =
                  user.role === UserRole.PROFESSIONAL ? professionalByUserId[user._id] : undefined;
                ...
                return (
                  <tr key={user._id} className="hover:bg-brand-cream/20 transition">
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span
                        className={`inline-block w-fit px-2.5 py-0.5 rounded-full text-xs font-medium ${roleStyle}`}
                      >
